...
namespace DDDTest.Tests
{
    ...
    public class WeatherSaveViewModelTest
    {
        ...
        public void 天気登録シナリオ()
        {
            ...
            viewModelMock.Setup(x => x.GetDateTime()).Returns(Convert.ToDateTime("2018/12/31 12:34:56"));
            var viewModel = viewModelMock.Object;
            viewModel.SelectedAreaId.IsNull();
            viewModel.DataDateValue.Is(Convert.ToDateTime("2018/12/31 12:34:56"));
            viewModel.SelectedCondition.Is(1);
            viewModel.TemparatureText.Is("");
            viewModel.TemparatureUnitName.Is("℃");
